...
//DecodeGetAllQuestionTypesRequest
func DecodeGetAllQuestionTypesRequest(ctx context.Context, r *http.Request) (interface{}, error) {
	log.Println("transport:DecodeGetAllQuestionTypesRequest")
	return r, nil
}

// EncodeGetAllQuestionTypesResponse
func EncodeGetAllQuestionTypesResponse(ctx context.Context, w http.ResponseWriter, response interface{}) error {
	log.Println("transport:EncodeGetAllQuestionTypesResponse ")
	resp := response.([]questionTypeResponse.QuestionTypeResponse)
	if len(resp) == 0 {
...
//QuestionTypeErrorEncoder will encode error to our format
func QuestionTypeErrorEncoder(ctx context.Context, err1 error, w http.ResponseWriter) {
	log.Println("transport:ErrorEncoder: Inside QuestionTypeErrorEncoder ")
